...
export class SuppliersController {
  ...
  @Post()
  async create(@Body() createSupplierDto: CreateSupplierDto) : Promise<OutputSupplierDto>
  {
    return new OutputSupplierDto(await this.suppliersService.create(createSupplierDto));
  }
  ...
  @UseGuards(UsersGuard)
  @Put(':id')
  async update(@Param('id') supplierId: string, @Body() createSupplierDto: CreateSupplierDto) : Promise<OutputSupplierDto>
  {
    return new OutputSupplierDto(await this.suppliersService.update(supplierId, createSupplierDto));
  }
